...
describe('preparationTimeInMinutes', () => {
  xtest('calculates the preparation time', () => {
...
describe('totalTimeInMinutes', () => {
  xtest('calculates the total cooking time', () => {
