...
import { buildSign, buildBirthdaySign, graduationFor, costOf } from './custom-signs';
...
describe('buildBirthdaySign', () => {
  xtest('age is less than 50', () => {
    expect(buildBirthdaySign(49)).toBe('Happy Birthday! What a young fellow you are.');
  });

  xtest('age is 50 or older', () => {
    expect(buildBirthdaySign(51)).toBe('Happy Birthday! What a mature fellow you are.');
  });

  xtest('age is 50', () => {
    expect(buildBirthdaySign(50)).toBe('Happy Birthday! What a mature fellow you are.');
  });
});
